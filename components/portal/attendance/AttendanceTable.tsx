...
interface AttendanceTableProps {
  ...
  /** When true, hides edit controls, toggle-all button, and save footer */
  readOnly?: boolean
}
...
export default function AttendanceTable({
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 gap-2">
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col items-center gap-0.5">
                      ...
                      {/* Toggle all button (only for today, and not readOnly) */}
                      {isToday && !readOnly && (
      ...
      {readOnly && (
        <div className="shrink-0 flex flex-wrap items-center gap-3 px-4 py-3 bg-gray-50 border-t border-gray-200">
