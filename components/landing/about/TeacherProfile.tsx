          ...
          {achievements.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Icon */}
                <div
                  className={`relative inline-flex h-14 w-14 mx-auto mb-4 items-center justify-center rounded-xl bg-gradient-to-br ${item.color} shadow-lg group-hover:scale-110 transition-transform`}
                >
          ...
          return (
            ...
            >
              ...
              <div className="relative">
                <div
                  className={`inline-flex h-12 w-12 mb-3 items-center justify-center rounded-xl bg-gradient-to-br ${stat.color} shadow-lg group-hover:scale-110 transition-transform`}
                >
