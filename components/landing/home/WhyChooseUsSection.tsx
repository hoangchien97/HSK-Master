            ...
            return (
              ...
              >
                ...
                <div className="relative mb-3 md:mb-4 lg:mb-6 flex items-center justify-center">
                  ...
                  <div className="relative z-10 inline-flex items-center justify-center w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-orange-100 to-red-100 dark:from-orange-900/30 dark:to-red-900/30 rounded-xl md:rounded-2xl transition-all duration-300 group-hover:scale-110 group-hover:animate-wiggle">
                    {IconComponent && <IconComponent className="w-6 h-6 md:w-7 md:h-7 lg:w-8 lg:h-8 text-orange-600 dark:text-orange-400" />}
                  </div>
                </div>
