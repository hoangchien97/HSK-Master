    ...
    data: [
      {
        pagePath: "/",
        pageName: "Trang chủ",
        title: "HSK Ruby - Trung tâm tiếng Trung uy tín tại Hà Nội | Luyện thi HSK 1-6",
        description: "Trung tâm tiếng Trung HSK Ruby - Đào tạo HSK 1-6, giao tiếp, thương mại. Giáo viên 8+ năm kinh nghiệm. Cam kết đầu ra. Học thử miễn phí.",
        keywords: "học tiếng Trung, HSK, trung tâm tiếng Trung Hà Nội, luyện thi HSK, học tiếng Trung online",
        ogTitle: "HSK Ruby - Trung tâm tiếng Trung uy tín #1 Hà Nội",
        ogDescription: "Học tiếng Trung chất lượng cao với HSK Ruby. Lộ trình cá nhân hóa, giáo viên giàu kinh nghiệm, cam kết đầu ra.",
        ogImage: "https://images.unsplash.com/photo-1523580494863-6f3031224c94?w=1200&h=630&fit=crop&q=80",
        twitterTitle: "HSK Ruby - Học tiếng Trung chuyên nghiệp",
      ...
      },
      {
        pagePath: "/about",
        pageName: "Giới thiệu",
        title: "Giới thiệu HSK Ruby - Trung tâm tiếng Trung chuẩn quốc tế Hà Nội",
        description: "Tìm hiểu về HSK Ruby - Trung tâm tiếng Trung chuyên nghiệp với đội ngũ giáo viên 8+ năm kinh nghiệm. Phương pháp giảng dạy hiện đại, cam kết chất lượng.",
        keywords: "giới thiệu HSK Ruby, trung tâm tiếng Trung uy tín, giáo viên tiếng Trung giỏi, học tiếng Trung Hà Nội",
        ogTitle: "Về HSK Ruby - Đào tạo tiếng Trung chuyên nghiệp",
      ...
      },
      {
        pagePath: "/contact",
        pageName: "Liên hệ",
        title: "Liên hệ HSK Ruby - Tư vấn khóa học tiếng Trung miễn phí | Hotline 0965322136",
        description: "Liên hệ HSK Ruby để được tư vấn lộ trình học tiếng Trung phù hợp. Hotline: 0965322136. Địa chỉ: Hà Nội. Tư vấn miễn phí, học thử 2 buổi.",
        keywords: "liên hệ HSK Ruby, tư vấn học tiếng Trung, đăng ký học HSK, hotline tiếng Trung Hà Nội",
      ...
      },
      {
        ...
        title: "Khóa học tiếng Trung - HSK 1-6, Giao tiếp, Thương mại | HSK Ruby",
        description: "Khám phá các khóa học tiếng Trung chất lượng cao tại HSK Ruby: HSK 1-6, Giao tiếp thực tế, Thương mại. Lộ trình cá nhân hóa, cam kết đầu ra.",
      ...
      },
      {
        pagePath: "/vocabulary",
        pageName: "Từ vựng",
        title: "Từ vựng tiếng Trung HSK - Học từ vựng theo cấp độ | HSK Ruby",
